...
public class newnewpratice {
    ...
    public static void main(String[] args)
        ...
        System.out.println("로그인하고자하는id를 입력해주세요: ");
        String id = scan.nextLine();

        System.out.println("로그인하고자하는비밀번호를 입력해주세요: ");
        ...
        if (logInUser.getName() != null) {
            System.out.println("학생 이름: " + logInUser.getName() + ", 생일: " + transFormat.format(logInUser.getBirth()));
        } else {
