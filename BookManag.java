...
public class BookManag {
	...
	public static void main(String[] args) {
		...
		bookArr[1][3] = "Elliotte Rusty";               // Author
		bookArr[1][4] = "OReilly Media";           // Publisher
		bookArr[1][5] = "true";                 // Member
		bookArr[1][6] = "0000002";
		bookArr[1][7] = "20190602";                // Start Date
		bookArr[1][8] = "20190616";                // End Date

		bookArr[2][0] = "0000003";                 // Number
		bookArr[2][1] = "Science";
		bookArr[2][2] = "Java Programming";   // Title
		bookArr[2][3] = "Scott Oaks";               // Author
		bookArr[2][4] = "OReilly Media";          // Publisher
		bookArr[2][5] = "false";
		bookArr[2][6] = "";           // Member
		bookArr[2][7] = "";                // Start Date
		bookArr[2][8] = "";                // End Date

		bookArr[3][0] = "0000004";                 // Number
		bookArr[3][1] = "Humanities";
		bookArr[3][2] = "Harry Potter and the Sorcerer";   // Title
		bookArr[3][3] = "Mary GrandPre";               // Author
		bookArr[3][4] = "Scholastic";          // Publisher
		bookArr[3][5] = "true";
		bookArr[3][6] = "0000004";           // Member
		bookArr[3][7] = "20190610";                // Start Date
		bookArr[3][8] = "20190624";                // End Date

		bookArr[4][0] = "0000005";                 // Number
		bookArr[4][1] = "Society";
		bookArr[4][2] = "The Silent Patient";   // Title
		bookArr[4][3] = "Alex Michaelides";               // Author
		bookArr[4][4] = "Celadon";          // Publisher
		bookArr[4][5] = "true";
		bookArr[4][6] = "0000003";           // Member
		bookArr[4][7] = "20190614";                // Start Date
		bookArr[4][8] = "20190628";                // End Date
		...
		while (user_menu) {
			...
			//System.out.println(bm.memberselect);
								...
								if (selectmem == 1) {
									...
									for(int k=0, l=0; k<bookArr.length; k++) {
										if (bookArr[k][6] == bm.memberselect) {
											l += 1;
											String retalMonth = bookArr[k][7].substring(4, 6);
				                            String retalDay = bookArr[k][7].substring(6);
				                            String returnMonth = bookArr[k][8].substring(4, 6);
				                            String returnDay = bookArr[k][8].substring(6);
				                            System.out.printf("%d. %30s %30s %30s %7s월 %7s일 %7s월 %7s일\n",l, bookArr[k][2], bookArr[k][3], bookArr[k][4], retalMonth, retalDay, returnMonth, retalDay);
										}
									}
					                ...
					                if(booksForReturn) { //반납할 도서가 있다면
					                    ...
					                    for(int i=0, j=0; i<bookArr.length; i++) {
					                        if(bookArr[i][6]==bm.memberselect) {
					                            j += 1;
					                            String retalMonth = bookArr[i][7].substring(4, 6);
					                            String retalDay = bookArr[i][7].substring(6);
					                            String returnMonth = bookArr[i][8].substring(4, 6);
					                            String returnDay = bookArr[i][8].substring(6);
					                            System.out.printf("%d. %30s %30s %30s %7s월 %7s일 %7s월 %7s일\n", j, bookArr[i][2], bookArr[i][3], bookArr[i][4], retalMonth, retalDay, returnMonth, retalDay);
					                        }
					                    }
